...
#define DESTZONE "TZ=America/New_York"
                  ...
                  float breath_voc_equivalent)
{
  ...
  printf("{\"IAQ\": %.0f,", iaq);
  printf("\"CO2\": %.2f,", co2_equivalent);
  printf("\"VOC\": %.2f,", breath_voc_equivalent);
  printf("\"Temperature\": %.2f,", temperature * 1.8 + 32);
  printf("\"Humidity\": %.2f,", humidity);
  printf("\"Pressure\": %.2f,", pressure * 0.0002953);
  printf("\"Gas\": %.2f,", gas);
  printf("\"Static_IAQ\": %.2f,", static_iaq);
  printf("\"Raw_Temperature\": %.2f,", raw_temperature * 1.8 + 32);
...
//  printf("%.2f,%.2f,%.2f", temperature * 1.8 + 32,
//         humidity,pressure * 0.0002953);
//  printf(",%.2f,%.2f", raw_temperature * 1.8 + 32, raw_humidity);
//  printf(",%.3f", gas / 1000);
//  printf(",%d,%d", bsec_status, iaq_accuracy);
//  printf(",%.2f", iaq);
//  printf(",%.2f", co2_equivalent);
//  printf(",%.2f", breath_voc_equivalent);
//  printf("\r\n");
...
int main()
{
   ...
   *
   */
  bsec_iot_loop(_sleep, get_timestamp_us, output_ready, state_save, 1200);
